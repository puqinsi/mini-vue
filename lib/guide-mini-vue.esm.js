...
// 清除多余空格，内容推进
function advanceBySpace(context) {
...
function transformCompound(node) {
    if (node.type === 2 /* NodeTypes.ELEMENT */) {
        return () => {
            const { children } = node;
...
export { createApp, createVNode as createElementBlock, createRenderer, createTextVNode, getCurrentInstance, h, inject, nextTick, provide, ref, registerRuntimeCompiler, renderSlots, toDisplayString };
